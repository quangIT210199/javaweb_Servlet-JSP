...
<!-- Tạo các biến cho các URL dùng để call cho dễ -->
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
						...
						<!-- Submit form theo kiểu API k như bên login.jsp theo Controller -->
                        <form id="formSubmit">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">Thể loại</label>
                                <div class="col-sm-9">
                                <!-- Luôn luôn phải có name="categoryCode" -->
                            ...
                            <!-- Khi cập nhật thì phải gửi thêm cái id về server, lấy id từ model đang sửa -->
...
/* 	var editor = '';
    ...
    $('#btnAddOrUpdateNew').click(function (e) {
        e.preventDefault();
        var data = {};
        var formData = $('#formSubmit').serializeArray();//lấy tất cả name và value trong Formsubmit cho vào mảng
        $.each(formData, function (i, v) {//v có 2 gtri là name và value , i là index
            data[""+v.name+""] = v.value;
        });
        /* data["content"] = editor.getData(); */
        var id = $('#id').val();
        if (id == "") {
            addNew(data);//thêm mới
        } else {
            updateNew(data);//sửa
        }
    });
