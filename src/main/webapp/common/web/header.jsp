...
<!-- Thêm header dùng chung: 
dùng sitemesh decorator, từ web.jsp ở folder decorators, gọi tk header.js-->
<!-- Navigation -->
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				...
				<c:if test="${not empty USERMODEL}">
					<li class="nav-item">
						<a class="nav-link" href='#'>Wellcome master, ${USERMODEL.fullName}</a>
					</li>
					<li class="nav-item">
